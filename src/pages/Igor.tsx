      ...
      <Container maxWidth='sm'>
        <Grid xs={12} className='boxCard' container style={{ marginTop: '250px' }}>
          <Grid container item style={{ position: 'absolute', marginBlockEnd: '280px' }}>
            <img style={{ position: 'absolute', borderRadius: '40px', width: '180px', height: '230px', padding: '5px 15px 20px 30px', marginBlockEnd: '240px', marginBlockStart: '535px', marginInlineEnd: '370px' }} src={'./image/Igor.jpg'} alt='Igor'></img>
          </Grid>
