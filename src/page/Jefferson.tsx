        ...
        <>
            <Container maxWidth='sm'>
                ...
                <Grid xs={12} className='boxCard' container style={{ marginTop: '150px' }}>
                    <Grid container item>
                        <img style={{ position: 'absolute', bottom: '90px', borderRadius: '40px', width: '180px', height: '230px', padding: '25px 15px 25px 30px' }} src={'./image/Jefferson.jpg'} alt='jefferson'></img>
                    </Grid>
